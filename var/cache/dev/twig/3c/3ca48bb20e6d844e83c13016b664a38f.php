...
\t\t\t\t\t\t\t\t\t<a class=\"nav-link fs-xl p-2\" href=\"";
            // line 56
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("cart_remove", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["formedeboxe"], "formedeboxe", [], "any", false, false, false, 56), "id", [], "any", false, false, false, 56)]), "html", null, true);
...
\t\t\t\t\t\t<span class=\"fs-3 fw-semibold text-dark ms-2\">";
        // line 66
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, (isset($context["total"]) || array_key_exists("total", $context) ? $context["total"] : (function () { throw new RuntimeError('Variable "total" does not exist.', 66, $this->source); })()), 2, ",", "."), "html", null, true);
        echo "
\t\t\t\t\t\t\t€</span>
\t\t\t\t\t</div>
...
";
    ...
    {
        return array (  207 => 77,  193 => 66,  188 => 63,  175 => 56,  167 => 51,  160 => 47,  154 => 44,  144 => 39,  138 => 35,  136 => 34,  131 => 33,  129 => 32,  122 => 28,  119 => 27,  112 => 22,  105 => 18,  94 => 10,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
...
\t\t{{ form_end(form) }}</div>
{% endblock %}
", "commande/index.html.twig", "/home/mary/Documents/dossier boxe/amiensbc8/templates/commande/index.html.twig");
    }
}
